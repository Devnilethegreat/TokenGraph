# TokenGraph: Token relationship graph explorer with intelligent cluster analysis Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

TokenGraph constructs and renders token interaction graphs from transfer histories, applies Louvain community detection, and labels clusters with AI-generated behavioural descriptions.
...
```bash
git clone https://github.com/Devnilethegreat/TokenGraph.git
cd TokenGraph
```
...
- **2024-10-18** — Expand test coverage for edge cases
- **2025-04-12** — Expand test coverage for edge cases
